...
module.exports = async function handler(req, res) {
  ...
  const prompt =
    ...
    "Exact shape: { \"title\": string|null, \"author\": string|null, \"series\": string|null, \"series_number\": number|null, \"genres\": string[], \"chapters\": number|null, \"confidence\": \"high\"|\"medium\"|\"low\" }. " +
    ...
    "Chapters: total number of chapters if you reliably know this specific book and edition (use null otherwise). For picture books, graphic novels, or works without traditional chapters, return null. Do not guess if uncertain. " +
  ...
  try {
    ...
    return res.status(200).json({
      ...
      chapters: (typeof book.chapters === 'number' && book.chapters > 0 && book.chapters < 999) ? book.chapters : null,
